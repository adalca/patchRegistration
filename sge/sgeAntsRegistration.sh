...
outdir="/data/vision/polina/scratch/patchRegistration/output/${datatype}/ANTs_v3_raw_fromDs7us7Reg_continueAffine_multiparam/"
mkdir -p $outdir
...
do
  ...
  do
    ...
    do
      ...
      outfileSeg="${subjpath}/final/${coreName}61-seg-in-${subjname}_via_${coreName}-invWarp.nii.gz"
    	outfileSegRaw="${subjpath}/final/${coreName}61-seg-in-${subjname}-raw_via_${coreName}-invWarp.nii.gz"
